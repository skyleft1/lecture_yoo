...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
		{
			...
			/* 
			 * Shocking but true - it would appear IE has major issues with having the viewpath not having
			 * a trailing slash on it. We need the cookie to be available based on the viewpath, so we
			 * have to append the file name to the cookie name. Appalling. Thanks to vex for adding the
			 * patch to use at least some of the viewpath
			 */
			...
			else
			{
				sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
					"; expires=" + date.toGMTString() +"; viewpath=" + aParts.join('/')+"/";
			}
			...
			if ( iLength+10 > 4096 ) /* Magic 10 for padding */
			{
				...
				if ( sOldName !== "" )
				{
					document.cookie = sOldName+"=; expires=Thu, 01-Jan-1970 00:00:01 GMT; viewpath="+
						aParts.join('/') + "/";
				}
			}
